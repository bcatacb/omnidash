...
let _buildNumber = 400000; // overwritten on first successful fetch (higher default for newer clients)
...
function buildSuperPropsB64(buildNumber: number): string {
  return Buffer.from(JSON.stringify({
    ...
    browser_user_agent: USER_AGENT, browser_version: "126.0.0.0", os_version: "10",
...
export function forceRefreshDiscordBuildNumber(): void {
  _buildNumberFetchedAt = 0;
}
