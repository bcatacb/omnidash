      ...
      <div className="flex-1 overflow-auto px-6 py-6 space-y-4">
        ...
        {!loading && !error && campaigns.length === 0 && (
          <div className="rounded-lg border border-dashed border-border bg-card p-12 text-center text-card-foreground shadow-sm">
            ...
            <h3 className="mt-4 text-[15px] font-medium text-foreground">No warmups yet</h3>
            <p className="mt-1 text-[13px] text-muted-foreground">
              Create your first warmup to open empty DM channels for a list of scraped leads.
            </p>
