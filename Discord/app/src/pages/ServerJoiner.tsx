...
import type { DiscordAccount, InvitePreview, JoinCampaign, JoinQueueRow } from "@/api-types"
...
function QueuePanel({ campaignId }: { campaignId: string }) {
  ...
  const load = useCallback(async () => {
    setLoading(true)
    try {
      const r = await fetch(`/api/join-campaigns/${campaignId}/queue`)
